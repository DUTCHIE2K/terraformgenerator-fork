...
public class TreeDB {
    ...
    public static void spawnSmallTropicTree(boolean skipGradientCheck,
                                            @NotNull TerraformWorld tw,
                                            @NotNull PopulatorDataAbstract data,
                                            int x,
                                            int y,
                                            int z)
    {
        ...
        FractalTreeBuilder ftb;
        if (GenUtils.chance(1, 8)) {
            ftb = new FractalTreeBuilder(FractalTypes.Tree.TROPIC_EXTRA_SMALL);
        }
        else {
            ftb = new FractalTreeBuilder(FractalTypes.Tree.TROPIC_SMALL);
        }
