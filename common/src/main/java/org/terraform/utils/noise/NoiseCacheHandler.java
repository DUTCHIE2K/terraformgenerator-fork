...
public class NoiseCacheHandler {
    ...
    public enum NoiseCacheEntry {
        ...
        BIOME_LAVA_PLATEAU_MASKNOISE,
        BIOME_LAVA_PLATEAU_CARVE,
        ...
        CAVE_V3_CHEESE_DYNAMIC_GEOMETRY_CONTROL_NOISE,
        CAVE_V3_CHEESE_DYNAMIC_CHAMBER_WEIGHT_CONTROL_NOISE,
        CAVE_V3_CHEESE_DYNAMIC_DEEP_BOOST_CONTROL_NOISE,
        CAVE_V3_TUNNEL_CHAMBER_LINK_NOISE,
        CAVE_V3_TUNNEL_AXIS_NOISE_A,
        CAVE_V3_TUNNEL_AXIS_NOISE_B,
        CAVE_V3_TUNNEL_CONTINUITY_NOISE,
        CAVE_V3_TUNNEL_JUNCTION_NOISE,
