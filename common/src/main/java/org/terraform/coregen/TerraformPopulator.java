...
public class TerraformPopulator extends BlockPopulator {
    ...
    private void logMissingCaveSnapshot(@NotNull TerraformWorld tw, @NotNull PopulatorDataAbstract data) {
        String chunkInfo = tw.getName() + " chunk " + data.getChunkX() + "," + data.getChunkZ();
