...
public class TConfig extends YamlFileInterface {
    ...
    @YamlComment("Lower separation means more frequent cave fluid pockets.")
    @YamlKey("biome.cave.fluid-cluster.separation")
    public int BIOME_CAVE_FLUIDCLUSTER_SEPARATION = 32;
    @YamlKey("biome.cave.fluid-cluster.separation-maxpertub")
    public double BIOME_CAVE_FLUIDCLUSTER_MAXPERTUB = 0.25d;
    @YamlKey("biome.cave.fluid-cluster.minsize")
    public int BIOME_CAVE_FLUIDCLUSTER_MINSIZE = 5;
    @YamlKey("biome.cave.fluid-cluster.maxsize")
    public int BIOME_CAVE_FLUIDCLUSTER_MAXSIZE = 9;
    @YamlComment("Chance a non-deep fluid cluster becomes lava instead of water.")
    @YamlKey("biome.cave.fluid-cluster.lava-chance")
    public int BIOME_CAVE_FLUIDCLUSTER_LAVA_CHANCE = 70;
    @YamlComment("Fluid clusters with center below minY + this depth always become lava.")
    @YamlKey("biome.cave.fluid-cluster.deep-lava-depth")
    public int BIOME_CAVE_FLUIDCLUSTER_DEEP_LAVA_DEPTH = 56;
