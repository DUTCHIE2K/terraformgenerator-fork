...
/*    WINDSWEPT_HILLS(new WindsweptHillsHandler(),
    ...
    ERODED_SAVANNA(new ErodedSavannaHandler(), BiomeType.FLAT, BiomeClimate.TRANSITION, TConfig.c.BIOME_PLAINS_WEIGHT),
    ...
    TROPIC_SWAMP(new TropicSwampHandler(), BiomeType.FLAT, BiomeClimate.HUMID_VEGETATION, TConfig.c.BIOME_SWAMP_WEIGHT),
