...
public class CustomBiomeHandler {
    ...
    public static void init() {
        ...
        Holder<Biome> mangroveBiome = registrywritable.createRegistrationLookup().getOrThrow(Biomes.MANGROVE_SWAMP);
        ...
        for (CustomBiomeType type : CustomBiomeType.values()) {
            ...
            try {
                Holder<Biome> baseBiomeHolder = type == CustomBiomeType.TROPIC_SWAMP ? mangroveBiome : forestbiome;
                registerCustomBiome(type, dedicatedserver, registrywritable, baseBiomeHolder);
    ...
    private static void registerCustomBiome(@NotNull CustomBiomeType biomeType,
                                                ...
                                                @NotNull Holder<Biome> baseBiomeHolder) throws Throwable
    {

        Biome baseBiome = baseBiomeHolder.value();
        ...
        newBiomeBuilder.hasPrecipitation(baseBiome.hasPrecipitation()); // c is hasPrecipitation

        // k is mobSettings
        var biomeSettingMobsField = new TerraformFieldHandler(Biome.class, "mobSettings","k");
        MobSpawnSettings biomeSettingMobs = (MobSpawnSettings) biomeSettingMobsField.field.get(baseBiome);
        ...
        BiomeGenerationSettings biomeSettingGen = (BiomeGenerationSettings) biomeSettingGenField.field.get(baseBiome);
        ...
        baseBiomeHolder.tags().forEach(tags::add);
